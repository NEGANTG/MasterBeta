    ...
    if query.data.startswith("file"):
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                caption=f'<b>📌 Requested By {query.from_user.mention}</b>\n\n<code>[@ᴍғ_ʟɪɴᴋᴢ] {title}</code>\n\n⚠️ <i></i>\n\n<i><b>©️ Powered by @MF_Linkz !</b></i>',
                protect_content=True if ident == "filep" else False 
            )
            msg1 = await query.message.reply(
                f'<b>📌 Requested By :{query.from_user.mention} </b>\n\n<b>📫 Your File is Ready</b>\n\n'           
                f'<b>📂 Fɪʟᴇ Nᴀᴍᴇ</b> : <code>[@ᴍғ_ʟɪɴᴋᴢ] {title}</code>\n\n'              
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+4twgt5a7kalkNjRl')
                        ]
                    ]
                )
            )
